    ...
    >
      ...
      <el-form-item label="证件类型" prop="credentialsType">
        <el-select v-model="ruleForm.credentialsType" placeholder="请选择证件类型">
          ...
          <el-option label="组织机构代码证" value="OrganizationCode"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="证件号码" prop="credentialsNum">
        <el-input v-model="ruleForm.credentialsNum" placeholder="点击输入证件号码"></el-input>
      </el-form-item>
      <el-form-item label="银行卡卡号" prop="cardId">
        <el-input v-model="ruleForm.cardId" placeholder="点击输入本人的银行卡号"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        credentialsNum: [
          ...
          { min: 18, max: 18, message: '身份证号码长度必须是18位', trigger: 'blur' }
        ],
        cardId: [
